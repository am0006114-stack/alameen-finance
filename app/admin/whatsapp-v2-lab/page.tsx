...
export default async function ArchiveLabPage() {
  ...
  return <main dir="rtl" className="min-h-screen bg-[#06110e] px-4 py-8 text-white"><div className="mx-auto max-w-7xl">
    <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between"><div><p className="text-sm font-black text-amber-200">ALAMEEN V2 — Phase 2.1</p><h1 className="text-3xl font-black">Archive Evaluation Lab</h1><p className="mt-2 max-w-3xl text-sm font-bold leading-7 text-[#b8c2bc]">Replay للأرشيف فقط. لا يرسل أي رد للعميل ولا يغيّر الطلب أو الدفع أو الإلغاء أو الاسترداد. العدادات هنا Global لكل الأرشيف، والبطاقات أسفلها تعرض آخر 250 حالة تمت معالجتها.</p></div><div className="flex flex-col gap-3"><ArchiveLabActions enabled={enabled}/><div className="flex gap-2"><Link href="/admin/whatsapp-v2-shadow" className="text-xs font-black text-cyan-200">V2 Shadow</Link><Link href="/admin/whatsapp" className="text-xs font-black text-cyan-200">المحادثات</Link></div></div></div>
