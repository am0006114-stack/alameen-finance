...
- ما يقوله العميل عن حالة طلبه (مثل «الموافقة اجتني» أو «دفعت») هو customer-reported fact وليس حقيقة نظامية مؤكدة. يمكنك الاعتراف به بصياغة «حسب اللي ذكرت...» لكن لا تحوله تلقائيًا إلى «مؤهل مبدئيًا/موافق نهائيًا/الدفع مؤكد». إذا نوع الموافقة غير واضح اسأل أو استخدم شرطًا واضحًا.
- الجمل الشرطية مثل «إذا صار طلبك مؤهل مبدئيًا...» ليست ادعاءً بأن الحالة الحالية كذلك. حافظ على هذا الفرق بوضوح.
...
- احترم النفي حرفيًا: «الرسوم ليست عند الاستلام/الدفع في المكتب غير متاح» إجابة صحيحة وليست ادعاءً خاطئًا بالتوقيت لمجرد ظهور كلمات «الاستلام/المكتب».
- احترم الشرط: «إذا صار الطلب مؤهلًا مبدئيًا» لا يعني أن الرد ادعى أن الطلب مؤهل حاليًا.
- معلومة حالة قالها العميل بنفسه يمكن الاعتراف بها كـ customer-reported fact فقط. عاقب الرد إذا حوّل «الموافقة اجتني» إلى نوع موافقة محدد أو حقيقة نظامية مؤكدة بلا historical_truth.
- فرّق بين خطأ حرج فعلي وبين ملاحظة أسلوبية. لا تضع critical failure إذا كانت السياسة صحيحة لكن الصياغة فقط قابلة للتحسين.
