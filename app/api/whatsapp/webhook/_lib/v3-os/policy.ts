...
function buildPolicy(): PolicyTruth {
  ...
  return {
    ...
    autonomousSupervisorRule: "كل تغيير فعلي على الطلب أو الإلغاء أو التراجع أو الاسترداد أو تعديل الجهاز/الحسبة ينفذه عمران فقط كمستوى Supervisor AI داخل النظام. لا يوجد انتظار موظف بشري.",
    forbiddenClaims: [
