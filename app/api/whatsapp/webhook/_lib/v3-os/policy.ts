...
function buildPolicy(): PolicyTruth {
  ...
  return {
    ...
    paymentMethodRule: "التحويل ممكن من أي حساب بنكي يدعم CliQ أو من محفظة إلكترونية. الجهة المستلمة محفظة Orange Money، والتحويل يكون إلى AMEEENPAY أو AMENPAY، ويجب مراجعة اسم المستفيد ABDUL RAHMAN ALHARAHSHEH قبل تأكيد الحوالة.",
