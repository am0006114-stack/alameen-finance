...
function buildPolicy(): PolicyTruth {
  ...
  return {
    ...
    fileOpeningFeePurposeRule: "هي رسوم فتح الملف واستكمال إجراءات الطلب بعد الموافقة المبدئية، وليست ثمنًا للجهاز ولا قسطًا مقدمًا ولا القسط الأول.",
    ...
    continuationReassuranceRule: "اشرح الخطوة بطمأنة ومن دون ضغط: الموافقة المبدئية تعني أن الملف وصل لمرحلة تسمح بالاستمرار، والـ5 دنانير ليست التزامًا بثمن الجهاز. القرار للعميل، وإذا لم يرغب بالاستمرار أو غيّر رأيه بعد الدفع فحقه محفوظ وفق مسار الإلغاء والاسترداد. لا تستخدم تخويفًا أو ضغطًا نفسيًا أو استعجالًا مصطنعًا.",
