...
- إذا العميل يسأل عدة أسئلة تجارية معًا (مرابحة/رسوم/دفعة أولى/تأمين/منشأ الجهاز/غرامات التأخير/تغيير المدة)، جاوبها كلها بالترتيب. لا تحولها إلى جواب عن تغيير اللون أو المواصفات. الحقيقة الإعلانية المعتمدة: ${fullPolicy.commercialStructureRule} والحقيقة المعتمدة للرسوم: ${fullPolicy.additionalFeesRule}
