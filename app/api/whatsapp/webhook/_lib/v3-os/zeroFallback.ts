...
function rawAsksRefundTiming(q: string) {
  return /(?:كم|قديش|متى|امتى|ايمتى|مده|مدة|وقت).{0,35}(?:الاسترداد|استرداد|الاسترجاع|استرجاع)|(?:الاسترداد|استرداد|الاسترجاع|استرجاع).{0,35}(?:كم|قديش|متى|امتى|ايمتى|مده|مدة|وقت|يوم)/.test(q);
}
