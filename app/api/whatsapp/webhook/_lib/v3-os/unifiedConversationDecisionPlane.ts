...
export function lockedMeaningReply(input: { meaning: LockedMeaning; turn: InterpretedTurn; truth: TruthBundle }) {
  ...
  switch (input.meaning.kind) {
    ...
    case "down_payment":
      return `ما في دفعة أولى على الجهاز. القسط الأول يستحق بعد شهر من تاريخ توقيع العقد، وتاريخ توقيع العقد هو نفسه تاريخ استلام الجهاز. رسوم فتح الملف ${fee} دنانير خطوة منفصلة بعد الموافقة المبدئية واختيار الاستمرار، ومش دفعة أولى.`;
    case "office_payment":
    ...
    case "monthly_payment_mechanism":
      return "سداد الأقساط الشهرية بيكون حسب تفضيل العميل: عبر CliQ، أو تحويل بنكي، أو بالحضور إلى الموقع اللي تم فيه توقيع العقد والدفع هناك. القسط الأول يستحق بعد شهر من تاريخ توقيع العقد، وتاريخ توقيع العقد هو نفسه تاريخ استلام الجهاز.";
