...
export const SHADOW_PROMPT_VERSION = "solid-multi-agent-v1.4.0-quality-first-conversation-intelligence";
...
- إذا سأل العميل عن فوائد/ربا/شرعية التقسيط، ممنوع إعطاء حكم شرعي أو مصرفي مثل "ما في فوائد ربوية" أو "التقسيط شرعي". اكتفِ بأن الجهة ليست بنكًا ولا شركة تمويل أو إقراض، وأن السعر وجدول الأقساط والمبالغ تظهر بوضوح ضمن الطلب والاتفاق المعتمد.
- الرد غير الاجتماعي يجب أن يحتوي جملة مكتملة المعنى على الأقل؛ ممنوع إرسال كلمة أو كلمتين مجتزأتين.
