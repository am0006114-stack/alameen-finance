...
function turnCoverageViolations(reply: string, preparation: V2ProductionPreparation, truth: V2ResolvedTruth) {
  ...
  const coverage: Array<[string, RegExp]> = [
    ...
    ["payment_method", /PAYAMEEEN|AMEEN1ST|AM500337|0788500337|AMEEENPAY|AMENPAY|CliQ|كليك|طريقة\s*الدفع/i],
    ["payment_timing", /متى|بعد\s*التأهيل|مرحلة\s*الدفع|الدفع\s*(?:مطلوب|غير\s*مطلوب)/i],
    ["payment_recipient", /المستفيد|ABDUL\s+RAHMAN|PAYAMEEEN|AMEEN1ST|AM500337|0788500337|AMEEENPAY|AMENPAY/i],
