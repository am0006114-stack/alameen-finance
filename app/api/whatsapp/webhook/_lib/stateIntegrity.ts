...
export function isExplicitRefundMutationText(text: string) {
  ...
  const direct = containsAny(t, [
    ...
    "رجعوا فلوسي", "رجعولي فلوسي", "رجعو فلوسي", "ردولي فلوسي", "ردوا فلوسي", "ردو فلوسي", "بدي فلوسي",
    "رجعولي الرسوم", "رجعوا الرسوم", "رجعو الرسوم", "ردولي الرسوم", "ردوا الرسوم", "ردو الرسوم",
  ...
  const ambiguousVerb = containsAny(t, ["رجعولي", "رجعهم", "رجعلي", "رجعوهم", "رجعو", "ردهم", "ردولي", "ردوا", "ردو"]);
