...
function errorMessage(error: string) {
  switch (error) {
    ...
    case "invalid_link":
      return "رابط رفع الهوية غير مطابق للطلب. افتح آخر رابط رسمي وصلك على واتساب.";
    case "invalid_state":
      return "هذا الرابط لم يعد متاحًا لحالة الطلب الحالية. تابع الطلب عبر واتساب لمعرفة الخطوة المطلوبة.";
    default:
