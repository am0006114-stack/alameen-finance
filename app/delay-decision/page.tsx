        ...
        {acceptedDelay ? (
          <section className="mt-5 rounded-[34px] border border-[#b8ddc4] bg-white/94 p-6 text-center shadow-[0_24px_70px_rgba(60,45,20,0.14)] sm:p-8">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-sm font-bold leading-8 text-[#526158]">
              سيتم استكمال الطلب بشكل طبيعي بعد انتهاء المراجعة الداخلية، وسيقوم فريق المتابعة بالتواصل معكم بخصوص موعد التسليم الجديد.
            </p>

            <div className="mx-auto mt-6 max-w-2xl rounded-[30px] border border-[#b8ddc4] bg-[#edf9f0] p-5">
              <p className="mb-3 text-sm font-black text-[#14723a]">
                الوقت المتبقي التقريبي على انتهاء التمديد
              </p>

              <CountdownTimer deadlineIso={countdownDeadline} />

              <p className="mt-4 text-xs font-bold leading-6 text-[#526158]">
                بداية العدّاد: {formatDateTime(app.delivery_delay_started_at)}
                <br />
                نهاية العدّاد المتوقعة: {formatDateTime(countdownDeadline)}
              </p>
            </div>
          </section>
        ) : refundRequested ? (
          <section className="mt-5 rounded-[34px] border border-[#e2c984] bg-white/94 p-6 text-center shadow-[0_24px_70px_rgba(60,45,20,0.14)] sm:p-8">
            <h2 className="text-2xl font-black text-[#7c5b13]">
            ...
            <section className="mt-5 rounded-[34px] border border-[#d8bd7a] bg-white/94 p-6 shadow-[0_24px_70px_rgba(60,45,20,0.14)] sm:p-8">
              ...
              <div className="grid gap-5 lg:grid-cols-2">
                ...
                <form action="/api/delay-decision" method="POST" className="rounded-[30px] border border-[#e2c984] bg-[#fff8e8] p-5">
                  ...
                  <div className="mt-4 grid gap-3">
                    <label className="block">
                      <span className="mb-2 block text-xs font-black text-[#7c5b13]">
                        رقم المحفظة / اسم كليك المراد التحويل له
                      </span>
                      <input
                        required
                        name="refundAccount"
                        className="w-full rounded-2xl border border-[#e2c984] bg-white px-4 py-3 text-right text-sm font-bold text-[#123725] outline-none focus:border-[#7c5b13]"
                        placeholder="مثال: 079xxxxxxx أو Alias Click"
                      />
                    </label>
                    ...
                    <label className="block">
                      ...
                      <input
                        ...
                        name="refundBank"
                        className="w-full rounded-2xl border border-[#e2c984] bg-white px-4 py-3 text-right text-sm font-bold text-[#123725] outline-none focus:border-[#7c5b13]"
                        placeholder="مثال: Orange Money / Click / بنك..."
                      />
                    </label>
                    ...
                    <label className="block">
                      ...
                      <input
                        ...
                        name="refundOwner"
                        className="w-full rounded-2xl border border-[#e2c984] bg-white px-4 py-3 text-right text-sm font-bold text-[#123725] outline-none focus:border-[#7c5b13]"
                        placeholder="الاسم كما يظهر على المحفظة أو الحساب"
                      />
                    </label>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="mt-5 w-full rounded-2xl bg-[#123725] px-5 py-4 text-sm font-black text-white shadow-lg transition hover:opacity-90"
                  >
                    إرسال طلب الاسترداد
                  </button>
                </form>
