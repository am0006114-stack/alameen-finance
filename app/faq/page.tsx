...
const faqs = [
  ...
  {
    question: "متى تظهر تفاصيل استكمال الطلب؟",
    answer:
      "تظهر للعميل تفاصيل الاستكمال والرسوم المرتبطة بالطلب في المرحلة المناسبة وبعد تحقق شروط الانتقال إليها، ولا تُعد أي مرحلة موافقة نهائية ما لم تظهر الحالة بذلك صراحة.",
  },
  {
    ...
    <main dir="rtl" className="v2-page v2-legal-page">
      ...
      <section className="v2-legal-hero">
        <div className="v2-container">
          ...
          <p>إجابات مباشرة عن اختيار الجهاز، التقديم، استكمال الطلب، المستندات، المتابعة والتسليم.</p>
        </div>
      </section>
